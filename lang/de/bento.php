...
$string['playbacksectionheading'] = 'Verfügbare Elemente der Präsentation';
$string['newtilesub'] = 'Beginnt mit einer einzelnen leeren Folie';
$string['playtile'] = 'Präsentation verbunden abspielen';
...
$string['demotilesub'] = 'Hier können Sie anschauen, wie Effekte gemacht werden, und ohne Folgen herumprobieren.';
...
$string['managepresentation'] = 'Importieren/Bearbeiten/Verteilen/Sichtbarkeit konfigurieren';
...
$string['backtomanage'] = 'Zurück zu Verteilen/Importieren';
...
$string['addassubmissiontile'] = 'Als Kachel übernehmen';
...
$string['settings_absolutemaxdocumentsize'] = 'Absolute Höchstgröße für Präsentationen (MB)';
$string['settings_absolutemaxdocumentsize_desc'] = 'Harte, seitenweite Obergrenze in Megabyte — keine einzelne Aktivität kann über ihre eigene „Maximale Dokumentgröße"-Einstellung darüber hinausgehen, egal was dort eingetragen wird. Bezieht sich auf die tatsächliche JSON-Größe der Präsentation (Bilder, Diagramme usw. eingerechnet), nicht auf die Datei selbst. Große, bildlastige Präsentationen brauchen entsprechend hohe Werte.';
$string['settings_savetimeout'] = 'Zeitüberschreitung beim Speichern (Sekunden)';
$string['settings_savetimeout_desc'] = 'Wie lange der Editor auf eine Antwort von Moodle wartet, bevor er das Speichern als fehlgeschlagen meldet, statt unbegrenzt und ohne Rückmeldung zu warten. Bei größeren Präsentationen oder langsameren Servern kann ein höherer Wert nötig sein.';
$string['settings_imagemaxdim'] = 'Maximale Bildkantenlänge (Pixel)';
$string['settings_imagemaxdim_desc'] = 'Bilder, deren längere Kante diesen Wert überschreitet, werden beim Einfügen automatisch verkleinert, bevor sie in die Präsentation eingebettet werden.';
$string['settings_imagequality'] = 'Bildqualität beim automatischen Verkleinern (%)';
$string['settings_imagequality_desc'] = 'JPEG-Qualität (1–100), mit der verkleinerte Bilder neu kodiert werden. Höhere Werte bedeuten bessere Qualität bei größeren Dateien.';
...
$string['allowstudentpaste_help'] = 'Erlaubt es Lernenden, beim Erstellen ihrer eigenen Präsentation Inhalte per Copy-Paste aus Webseiten oder Dokumenten einzufügen. Standardmäßig deaktiviert — Copy-Paste ist als Abkürzung verlockend genug, dass diese Möglichkeit bewusst freigegeben werden sollte, statt automatisch mit den Schüler-Einreichungen aktiviert zu sein. Diese Einstellung bietet sich vor allem dann an, wenn die Schüler schon digitale Inhalte erarbeitet haben, auf denen sie in der Präsentation aufbauen sollen.';
$string['maxdocumentsize'] = 'Maximale Dokumentgröße (MB)';
$string['maxdocumentsize_help'] = 'Größenobergrenze für diese Aktivität — bezieht sich auf die tatsächliche Größe der Präsentation (Bilder, Diagramme usw. eingerechnet), nicht auf die Datei selbst. Gilt für die eigene Präsentation der Lehrperson sowie für Schüler-Einreichungen, sofern für diese keine eigene Grenze festgelegt wurde. Kann die von der Website-Administration festgelegte absolute Höchstgrenze nur unterschreiten, nie überschreiten.';
$string['maxdocumentsize_toosmall'] = 'Muss mindestens 1 MB betragen.';
$string['maxdocumentsize_exceedsabsolute'] = 'Darf die von der Website-Administration festgelegte absolute Höchstgrenze von {$a} MB nicht überschreiten.';
$string['maxstudentdocumentsize'] = 'Maximale Dokumentgröße für Schüler-Einreichungen (MB)';
$string['maxstudentdocumentsize_help'] = 'Eigene, separate Größenobergrenze speziell für Schüler-Einreichungen. Leer oder 0 lassen, um stattdessen die „Maximale Dokumentgröße" oben zu verwenden. Kann die von der Website-Administration festgelegte absolute Höchstgrenze nur unterschreiten, nie überschreiten.';
