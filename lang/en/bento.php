...
$string['editusehint'] = 'Drop a file here to merge it with what\'s already saved — for slide-by-slide changes, open the presentation for editing instead.';
...
$string['playtile'] = 'Play';
$string['playtilesub'] = 'Opens the currently saved presentation';
$string['demotile'] = 'Demo/Tutorial';
$string['demotilesub'] = 'Feature tour as a presentation — opens directly, changes nothing';
...
$string['maxdocumentsize_help'] = 'Size ceiling for this activity — refers to the presentation\'s actual size (images, charts, etc. included), not the file on disk. Applies to both the teacher\'s own presentation and student submissions. Can only be set lower than the site-wide absolute ceiling, never higher.';
